    ...
    <body> 
        <?php 
            ...
            if ($result1->num_rows > 0) { 
                ...
                $sqlContrasena2 = "UPDATE usuario "."SET usu_password = MD5($contrasena2),"."usu_fecha_modificacion = 
                '$fecha' "."WHERE usu_codigo = $codigo"; 
                ...
                if ($conn->query($sqlContrasena2) === TRUE) { 
                    ...
                    echo "<p>Error: ".mysqli_error($conn)."</p>"; } 
                        ...
                        echo "<a href='../../vista/usuario/index.php'>Regresar</a>"; $conn->close();
         ?> 
    </body> 
</html>